...
void paranoia_set_range(cdrom_paranoia *p, long firstsector, long lastsector)
{
    ...
    p->cursor = firstsector;
    p->current_firstsector = firstsector;
    p->current_lastsector = lastsector;
}
